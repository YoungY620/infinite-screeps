...
- **Current tasks:**
  - Full speed upgrading to RCL5 (~25.3K more progress needed)
...
- **Next goal:**
  - Upgrade to RCL5 (requires ~25.3K more progress)
